...
<!--<template>-->
  <!--<div>-->
    <!--<app-detail-header :title="'Meter Blacklist'" :sub-title="''"></app-detail-header>-->
    ...
    <!--<section class="content">-->
      <!--<div class="box box-warning">-->
        <!--<div class="box-body">-->
          ...
          <!--<table v-if="!isError" :id="tableId" ref="tableId" class="table table-bordered table-striped">-->
            <!--<thead>-->
            <!--<tr slot="header">-->
              <!--<th v-for="header in headers"><span class="text">{{ header }}</span></th>-->
            <!--</tr>-->
            <!--</thead>-->
            <!--<tfoot>-->
            <!--<tr slot="header">-->
  ...
  <!--export default {-->
    <!--data() {-->
      <!--return {-->
        ...
        <!--dataFields: ['meterBlackListId', 'partnerId', 'pattern'],-->
        <!--headers: ['ID','Partner', 'Pattern'],-->
        <!--dataTypes: ['numeric', 'string', 'string'],-->
        <!--dataRenders: [-->
          <!--null,-->
          <!--null,-->
          <!--null,-->
      ...
      <!--buildTable() {-->
        <!--$('#' + this.tableId).DataTable({-->
          ...
          <!--buttons: [-->
            ...
            <!--{ "extend": 'pdf', "text":'<i class="fa fa-file-pdf-o"></i> PDF',"className": 'btn bg-primary btn-xs' },-->
            <!--{ "extend": 'print', "text":'<i class="fa fa-print"></i> Print',"className": 'btn btn-warning btn-xs' },-->
            <!--{ "extend": 'copy', "text":'<i class="fa fa-copy"></i> Copy',"className": 'btn btn-danger btn-xs' },-->
          <!--]-->
        <!--});-->

        <!--$('div.dataTables_filter input').css(-->
          <!--{'width':'350px','display':'inline-block', 'border':'1px solid #3b8ab8', 'padding': '5px'}-->
        <!--);-->
